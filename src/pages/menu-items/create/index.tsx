    ...
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <FormControl id="ingredients" mb="4" isInvalid={!!formik.errors?.ingredients}>
            <FormLabel>Ingredients</FormLabel>
            <Input type="text" name="ingredients" value={formik.values?.ingredients} onChange={formik.handleChange} />
            {formik.errors.ingredients && <FormErrorMessage>{formik.errors?.ingredients}</FormErrorMessage>}
          </FormControl>
